...
namespace HitbtcSharp
{
    public class HitbtcSocket : ISocketExchange
    {
        ...
        ITargetBlock<RpcClient> CreateNeverEndingTask(
Func<RpcClient, CancellationToken, Task> action,
CancellationToken cancellationToken)
        {
            ...
            ActionBlock<RpcClient> block = null;
            ...
            // delay comes.
            block = new ActionBlock<RpcClient>(async client =>
            {
