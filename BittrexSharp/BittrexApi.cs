...
namespace BittrexSharp
{
    public class BittrexApi
    {
        ...
        /// <param name="marketName">The name of the market, e.g. BTC-LTC</param>
        /// <returns></returns>
        public virtual async Task<IEnumerable<MarketSummary>> GetMarketSummary(string marketName)
        {
            ...
            var jsonResponse = await request(HttpMethod.Get, uri, parameters, false);
            var marketSummary = jsonResponse.ToObject<IEnumerable<MarketSummary>>();
        ...
        /// <param name="currency">Currency symbol, e.g. BTC</param>
        /// <returns></returns>
        public virtual async Task<Core.Contracts.IDepositAddress> GetDepositAddress(string currency)
        {
